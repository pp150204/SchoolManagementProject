...
void main() async {
  ...
  // Using different names to avoid rate limit/cache issues if possible
  final accounts = [
    {'email': 'test_student@school.com', 'password': 'School@123'},
    {'email': 'test_admin@school.com', 'password': 'School@123'},
    {'email': 'test_teacher@school.com', 'password': 'School@123'},
  ];
  ...
  for (var acc in accounts) {
    ...
    // Sleep briefly between requests to mitigate rate limiting
